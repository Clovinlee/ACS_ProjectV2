...
DROP TABLE BUSSINESS_PARTNER CASCADE CONSTRAINTS PURGE;
DROP TABLE WAREHOUSE CASCADE CONSTRAINTS PURGE;
DROP TABLE RAK_WAREHOUSE CASCADE CONSTRAINTS PURGE;
...
CREATE TABLE BARANG_WAREHOUSE(
    ID NUMBER PRIMARY KEY,
    ID_RAK NUMBER REFERENCES RAK_WAREHOUSE(ID) NOT NULL,
...
CREATE TABLE H_KELUAR_BARANG(
    ...
    ID_PARTNER NUMBER REFERENCES BUSSINESS_PARTNER(ID) NOT NULL,
    TANGGAL DATE NOT NULL,
    ID_WAREHOUSE NUMBER REFERENCES WAREHOUSE(ID) NOT NULL
);
...
CREATE TABLE H_ORDER_SUPPLIER(
    ...
    QTY NUMBER NOT NULL,
    ID_WAREHOUSE NUMBER REFERENCES WAREHOUSE(ID)  NOT NULL,
    ID_PEGAWAI NUMBER REFERENCES USERS(ID) NOT NULL,
...
-- WAREHOUSE
INSERT INTO WAREHOUSE VALUES(1, 'Warehouse 1', 'Jalan Monyet Nomor 1', '081357630987');
INSERT INTO WAREHOUSE VALUES(2, 'Warehouse 2', 'Jalan Harimau Nomor 12', '081398819927');
INSERT INTO WAREHOUSE VALUES(3, 'Warehouse 3', 'Jalan Singa Nomor 98', '081157483981');
INSERT INTO WAREHOUSE VALUES(4, 'Warehouse 4', 'Jalan Kuda Nomor 23', '081147630230');
INSERT INTO WAREHOUSE VALUES(5, 'Warehouse 5', 'Jalan Raja Nomor 99', '081262580920');

-- BUSINESS PARTNER
INSERT INTO BUSSINESS_PARTNER VALUES(1, 'SU0001', 'PT Mega', '087487293012', 'Jalan Sejahtera Jaya Nomor 3');
INSERT INTO BUSSINESS_PARTNER VALUES(2, 'SU0002', 'PT Dua', '087487293144', 'Jalan Kenangan Indah Nomor 12');
INSERT INTO BUSSINESS_PARTNER VALUES(3, 'SU0003', 'PT Jaya Mega', '081019893532', 'Jalan Gula Gula Nomor 20');
INSERT INTO BUSSINESS_PARTNER VALUES(4, 'DI0001', 'Toko Mega Sumber Rezeki', '087487883054', 'Jalan Ku Bukan Jalan Mu Nomor 02');
INSERT INTO BUSSINESS_PARTNER VALUES(5, 'DI0002', 'Toko Alfa Komputer Teknik', '087469293031', 'Jalan Kenangan Blok B Nomor 9');
INSERT INTO BUSSINESS_PARTNER VALUES(6, 'DI0003', 'CV Sumber Maju Bersama', '087482293000', 'Jalan Bersama Dia Nomor 88');
...
INSERT INTO BARANG_WAREHOUSE VALUES(3, 2, 3, 3, 1);
INSERT INTO BARANG_WAREHOUSE VALUES(4, 2, 4, 2, 1);
INSERT INTO BARANG_WAREHOUSE VALUES(5, 3, 5, 2, 1);
INSERT INTO BARANG_WAREHOUSE VALUES(6, 3, 6, 2, 1);
INSERT INTO BARANG_WAREHOUSE VALUES(7, 3, 7, 3, 1);
INSERT INTO BARANG_WAREHOUSE VALUES(8, 4, 8, 4, 1);
INSERT INTO BARANG_WAREHOUSE VALUES(9, 4, 9, 1, 0);
INSERT INTO BARANG_WAREHOUSE VALUES(10, 5, 10, 3, 1);
INSERT INTO BARANG_WAREHOUSE VALUES(11, 5, 11, 2, 1);
INSERT INTO BARANG_WAREHOUSE VALUES(12, 6, 12, 5, 1);
INSERT INTO BARANG_WAREHOUSE VALUES(13, 6, 13, 2, 1);
INSERT INTO BARANG_WAREHOUSE VALUES(14, 7, 14, 1, 1);
INSERT INTO BARANG_WAREHOUSE VALUES(15, 7, 15, 1, 1);
INSERT INTO BARANG_WAREHOUSE VALUES(16, 8, 16, 1, 1);
INSERT INTO BARANG_WAREHOUSE VALUES(17, 9, 17, 5, 1);
INSERT INTO BARANG_WAREHOUSE VALUES(18, 9, 18, 1, 1);
INSERT INTO BARANG_WAREHOUSE VALUES(19, 9, 19, 1, 1);
INSERT INTO BARANG_WAREHOUSE VALUES(20, 10, 20, 2, 1);
INSERT INTO BARANG_WAREHOUSE VALUES(21, 11, 21, 2, 1);
INSERT INTO BARANG_WAREHOUSE VALUES(22, 12, 22, 5, 1);
INSERT INTO BARANG_WAREHOUSE VALUES(23, 13, 23, 5, 0);
INSERT INTO BARANG_WAREHOUSE VALUES(24, 14, 24, 4, 1);
INSERT INTO BARANG_WAREHOUSE VALUES(25, 15, 25, 1, 1);
INSERT INTO BARANG_WAREHOUSE VALUES(26, 15, 26, 2, 1);
INSERT INTO BARANG_WAREHOUSE VALUES(27, 15, 27, 3, 1);

-- ADJUSTMENT
INSERT INTO ADJUSTMENT VALUES(1, 2, 3, TO_DATE('01/12/2021','DD/MM/YYYY'), 1, 'Barang Rusak');
INSERT INTO ADJUSTMENT VALUES(2, 5, 3, TO_DATE('22/04/2021','DD/MM/YYYY'), 17, 'Ada kesalahan penghitungan');
INSERT INTO ADJUSTMENT VALUES(3, 2, 1, TO_DATE('14/07/2021','DD/MM/YYYY'), 21, 'Ada penambahan barang yang belum terhitung');
INSERT INTO ADJUSTMENT VALUES(4, 5, 6, TO_DATE('04/10/2021','DD/MM/YYYY'), 22, 'Barang Rusak');
INSERT INTO ADJUSTMENT VALUES(5, 2, 3, TO_DATE('30/11/2021','DD/MM/YYYY'), 26, 'Barang Rusak');

-- HISTORY BARANG KELUAR MASUK
INSERT INTO HISTORY_BARANG_KELUAR_MASUK VALUES(1, TO_DATE('04/05/2021', 'DD/MM/YYYY'), 1, null, 0);
INSERT INTO HISTORY_BARANG_KELUAR_MASUK VALUES(3, TO_DATE('04/05/2021', 'DD/MM/YYYY'), 3, null, 0);
INSERT INTO HISTORY_BARANG_KELUAR_MASUK VALUES(5, TO_DATE('04/05/2021', 'DD/MM/YYYY'), 2, null, 0);
INSERT INTO HISTORY_BARANG_KELUAR_MASUK VALUES(15, TO_DATE('17/03/2021', 'DD/MM/YYYY'), 1, null, 0);
INSERT INTO HISTORY_BARANG_KELUAR_MASUK VALUES(19, TO_DATE('17/03/2021', 'DD/MM/YYYY'), 4, null, 0);
INSERT INTO HISTORY_BARANG_KELUAR_MASUK VALUES(14, TO_DATE('28/02/2021', 'DD/MM/YYYY'), 1, null, 0);
INSERT INTO HISTORY_BARANG_KELUAR_MASUK VALUES(16, TO_DATE('28/02/2021', 'DD/MM/YYYY'), 2, null, 0);
INSERT INTO HISTORY_BARANG_KELUAR_MASUK VALUES(17, TO_DATE('28/02/2021', 'DD/MM/YYYY'), 4, null, 0);
INSERT INTO HISTORY_BARANG_KELUAR_MASUK VALUES(19, TO_DATE('28/02/2021', 'DD/MM/YYYY'), 1, null, 0);
INSERT INTO HISTORY_BARANG_KELUAR_MASUK VALUES(8, TO_DATE('15/11/2021', 'DD/MM/YYYY'), 2, null, 0);
INSERT INTO HISTORY_BARANG_KELUAR_MASUK VALUES(10, TO_DATE('15/11/2021', 'DD/MM/YYYY'), 3, null, 0);
INSERT INTO HISTORY_BARANG_KELUAR_MASUK VALUES(24, TO_DATE('23/07/2021', 'DD/MM/YYYY'), 1, null, 0);
INSERT INTO HISTORY_BARANG_KELUAR_MASUK VALUES(26, TO_DATE('23/07/2021', 'DD/MM/YYYY'), 3, null, 0);
INSERT INTO HISTORY_BARANG_KELUAR_MASUK VALUES(27, TO_DATE('23/07/2021', 'DD/MM/YYYY'), 2, null, 0);
INSERT INTO HISTORY_BARANG_KELUAR_MASUK VALUES(2, TO_DATE('30/03/2021', 'DD/MM/YYYY'), 3, null, 1);
INSERT INTO HISTORY_BARANG_KELUAR_MASUK VALUES(3, TO_DATE('30/03/2021', 'DD/MM/YYYY'), 1, null, 1);
INSERT INTO HISTORY_BARANG_KELUAR_MASUK VALUES(4, TO_DATE('30/03/2021', 'DD/MM/YYYY'), 1, null, 1);
INSERT INTO HISTORY_BARANG_KELUAR_MASUK VALUES(16, TO_DATE('27/08/2021', 'DD/MM/YYYY'), 2, 'Terlambat 2 hari', 1);
INSERT INTO HISTORY_BARANG_KELUAR_MASUK VALUES(19, TO_DATE('27/08/2021', 'DD/MM/YYYY'), 2, 'Terlambat 2 hari', 1);
...
-- H PINDAH 
INSERT INTO H_PINDAH VALUES('HP0001', 1, 2, 2, TO_DATE('02/12/2021','DD/MM/YYYY'));
INSERT INTO H_PINDAH VALUES('HP0002', 5, 3, 2, TO_DATE('03/12/2022','DD/MM/YYYY'));
INSERT INTO H_PINDAH VALUES('HP0003', 2, 4, 4, TO_DATE('24/01/2022','DD/MM/YYYY'));
...
-- H ORDER SUPPLIER
INSERT INTO H_ORDER_SUPPLIER VALUES('HO210320210001', 1, TO_DATE('30/03/2021', 'DD/MM/YYYY'), 3, 5, 1, 4, 15450000);
INSERT INTO H_ORDER_SUPPLIER VALUES('HO140820210001', 2, TO_DATE('25/08/2021', 'DD/MM/YYYY'), 2, 4, 3, 1, 27545000);
INSERT INTO H_ORDER_SUPPLIER VALUES('HO031220210001', 3, TO_DATE('23/01/2022', 'DD/MM/YYYY'), 1, 6, 4, 3, 21760000);
