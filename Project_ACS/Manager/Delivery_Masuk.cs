        ...
        private void btnInsert_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (dialogResult == DialogResult.Yes)
                {
                    ...
                    querystr = $"INSERT INTO H_ORDER_SUPPLIER VALUES('{kode}',{cbb_partner.SelectedIndex+1},TO_DATE('{eta}', 'DD/MM/YYYY'),1,{totalbarang},{User.User_login.Id_warehouse},{User.User_login.Id},0)";
